...
void init_timer1_ch0(void)
{
	// TPM1C0SC = 0b01001000;
	TPM1C0SC_CH0F = 0;		// capture/compare event
	TPM1C0SC_CH0IE = 1;		// interrupt enable
	TPM1C0SC_MS0x = 0b00;	// capture mode
	TPM1C0SC_ELS0x = 0b11;	// falling and rising edge
}

interrupt void get_time(void)
{
	TPM1C1SC_CH1F = 0;		// reset the interrupt flag
